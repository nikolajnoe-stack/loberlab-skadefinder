...
window.llCloseModalOnOverlay = window.llCloseModalOnOverlay || function(e) {
  ...
  var I = [
    ...
    { id: 'itb_syndrome', n: 'Løberknæ', f: 'Iliotibial bånd syndrom (ITBS)', a: 'knee', loc: ['outer'], ch: ['sharp', 'burning'], ti: ['during', 'after_distance'], on: ['gradual'], ag: ['hills_down', 'stairs_down', 'after_distance'], de: 'Smerte på ydersiden af knæet – ofte kaldet løberknæ.', w: { mild: 6, moderate: 10, severe: 16 } },
